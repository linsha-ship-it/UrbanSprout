      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-sm text-forest-green-600 hover:text-forest-green-500">
              Forgot password?
            </a>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-forest-green-500">Or continue with</span>
            </div>
          </div>
            ...
            <button
              ...
              onClick={async () => {
                try {
                  ...
                  // TODO: Optionally POST to backend /api/auth/google if needed for JWT
        ...
        >
          <p className="text-forest-green-600">
            ...
            <Link to="/signup" className="font-medium text-forest-green-500 hover:text-forest-green-400 transition-colors">
              Sign up here
            </Link>
          </p>
        </motion.div>
