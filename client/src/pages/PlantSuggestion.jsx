...
const PlantSuggestion = () => {
  ...
  const generateResults = async () => {
    ...
    try {
      const response = await apiCall('/plants/suggestions', {
        method: 'POST',
        body: JSON.stringify({
          space: answers.space,
      ...
      if (response.success) {
        setResults({
          ...
          recommendations: response.recommendationMessage,
          combinationKey: response.combinationKey
        });
      } else {
      ...
      const fallbackPlants = [
        ...
        { name: 'Bell Pepper', category: 'Vegetables', description: 'Colorful peppers that add flavor.', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=300&h=200&fit=crop&q=80', growingTime: '70-90 days', sunlight: 'Full Sun', space: 'Small', difficulty: 'Easy', price: '₹25-40' },
